...
public final class LC {
    ...
    @Supported
    public static final KnownKey imapd_truststore = KnownKey.newKey("${mailboxd_truststore}");
    @Supported
    public static final KnownKey imapd_truststore_password = KnownKey.newKey("${mailboxd_truststore_password}");
